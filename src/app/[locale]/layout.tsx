...
export function generateMetadata({
  ...
  return {
    ...
    title: {
      default: 'Dario Prawara Teh',
      template: '%s | Dario Prawara Teh',
    },
    authors: [{ name: 'Dario Prawara Teh' }],
    applicationName: 'Dario Prawara Teh',
    description: 'AI Software Engineer and Student at Singapore Polytechnic',
    openGraph: {
      title: 'Dario Prawara Teh',
      description: 'AI Software Engineer and Student at Singapore Polytechnic',
      url: env.NEXT_PUBLIC_WEBSITE_URL,
      siteName: 'Dario Prawara Teh',
      images: [
        {
