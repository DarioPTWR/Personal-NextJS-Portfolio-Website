...
import profilePic from 'public/static/images/dario.png';
    ...
    <>
      <div className="flex flex-col-reverse items-start sm:flex-row">
        <div className="flex flex-col pr-8">
          ...
          <h2 className="mt-3 mb-4 text-gray-700 dark:text-gray-200">
            {t('index-page.title')} Singapore Polytechnic
          </h2>
          <p className="mb-12 text-gray-600 dark:text-gray-300">
            {t('index-page.intro')}
          </p>
        </div>
        <div className="relative mb-8 mr-auto w-[90px] sm:mb-0 sm:w-[250px]">
          <Image
            alt=" Dario Prawara Teh"
            height={500}
            width={500}
            src={profilePic}
            placeholder="blur"
      ...
      <Link
        href={`/${locale}/blog`}
        className="mb-12 mt-8 flex h-6 cursor-pointer items-center rounded-lg leading-7 text-gray-600 transition-all hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-200">
